...
export type NotificationEvent = "domain_expiry" | "ssl_expiry" | "sync_report" | "dns_change" | "whois_change";
...
export const NOTIFICATION_EVENTS: { value: NotificationEvent; label: string; description: string }[] = [
  ...
  { value: "whois_change", label: "WHOIS Change Alerts", description: "Get notified when WHOIS details (registrar, nameservers, etc.) change" },
];
